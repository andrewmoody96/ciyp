  ...
  return (
    <>
      <div className="nav">
        ...
        >
          <button className="font-arvo m-2 p-[5px] rounded-lg hover:text-[#B36551]">
            <Link to="/">Home</Link>
          </button>
          {/* Shows, Email Signup */}
          <button className="font-arvo m-2 p-[5px] rounded-lg hover:text-[#B36551]">
        ...
        <h1 className="fixed top-0 right-0 text-4xl text-center text-white font-monoton m-2 my-1 p-1">
          CIYP
        </h1>
      </div>
    </>
