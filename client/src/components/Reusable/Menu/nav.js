    ...
    <>
      <div className="nav">
        <ul
          ...
          className="bg-[#262626] border-r border-b rounded-br-md h-auto w-[50vw] mt-[3.1rem] absolute font-arvo text-white"
        >
          <button className="font-arvo mx-1 p-[5px] rounded-lg hover:text-[#B36551] my-2">
            <Link to="/">Home</Link>
          </button>
          {/* Shows, Email Signup */}
          <button className="font-arvo mx-1 p-[5px] rounded-lg hover:text-[#B36551] my-2">
        ...
        <h1 className="fixed top-0 right-0 text-4xl text-center text-white font-monoton mx-2 my-1 p-1">
          CIYP
        </h1>
      </div>
    </>
