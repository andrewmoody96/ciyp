...
export default function ThirdSingle() {
      ...
      return (
        <div className="my-5 m-3 flex flex-col justify-center items-center">
          <div className="tablet:flex">
            <section className="bg-[#c98c40]/40 border border-[#E8B380] rounded-lg flex-col justify-center items-center mx-2 my-5 text-center text-white font-arvo drop-shadow-[0_1px_5px_rgba(0,0,0,0.6)] tablet:w-[40vw] desktop:w-auto">
              <div className="flex flex-col items-center justify-center">
                <p className="mt-10 mb-5 text-2xl desktop:text-4xl font-arvo text-white drop-shadow-[2px_2px_1px_rgba(0,0,0,1)]">{`${process.env.REACT_APP_SINGLE3_TITLE}`}</p>
                {!isLoaded ? (
                  <p>...loading</p>
                ) : (
                  <img
              ...
              <div className="flex flex-row justify-center">
                ...
                <button className="p-2 mx-4 my-10 border border-black rounded-lg drop-shadow-[0_1px_5px_rgba(255,255,225,0.4)] bg-[#B36551] font-arvo text-black desktop:text-lg text-center w-[40vw] tablet:w-[25vw] desktop:w-[10vw] hover:bg-red-300 hover:text-black">
                  <Link
                    className="mx-1 drop-shadow-[0_1px_2px_rgba(201,139,64,1)]"
                    to="/contact"
                  >
          ...
          <div className="flex flex-col justify-center items-center w-auto">
            <section className="bg-[#c98c40]/50 border border-[#E8B380] rounded-lg flex flex-col justify-center items-center mx-2 my-5 text-center text-white font-arvo drop-shadow-[0_1px_5px_rgba(0,0,0,0.6)] tablet:w-[40vw] desktop:w-auto">
              <div className="flex flex-col items-center justify-center max-w-[75vw]">
  ...
  return (
    <div className="flex flex-col w-[100%] justify-center items-center overflow-x-hidden">
      ...
      <div className="h-[10vw]">{/* dummy div */}</div>
    </div>
  );
}

// consistently render album art in correct order
// sort array
