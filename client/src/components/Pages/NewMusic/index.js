...
const featuredSingle = "https://storage.googleapis.com/ciyp-photos/Album%20Art/Eurydice%20-%20ARTWORK.webp"
        ...
        <section className="desktop:grid desktop:grid-cols-2">
          ...
          <section className="m-2">
            ...
            <div className="flex justify-center items-center text-sm">
              ...
              <Link to="/melting">
                <button className="p-1 mx-2 my-2 desktop:my-5 border border-black rounded-lg drop-shadow-[0_1px_5px_rgba(255,255,225,0.4)] bg-[#B36551] font-moda text-black text-sm desktop:text-lg text-center w-[29vw] tablet:w-[20vw] desktop:w-[10vw] hover:bg-red-300 hover:text-black">
                  More
                </button>
              </Link>
            </div>
